  ...
  res.render('index', {
    ...
    main: {
      index: {
        ...
        text: 'Я студент в школі програмування IT-Brains де вивчаю мову програмування JavaScript.',
      },
    },
  })
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Background verification - is a feature that provides users to prove that are real persons',
                },
                {
